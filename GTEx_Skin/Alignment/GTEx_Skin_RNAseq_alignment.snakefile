...
# Directories
FQ_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Skin/RNAseq/trimmed_fastqs/" # path to directory with fastq files
SAM_AL_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Skin/RNAseq/GRCh38_SAM/" # path to directory for SAM alignment files
BAM_AL_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Skin/RNAseq/GRCh38_BAM/" # path to directory for BAM alignment files
SORTED_BAM_AL_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Skin/RNAseq/GRCh38_sorted_BAM/" # path to directory for sorted BAM alignment files
FEATURECOUNTS_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Skin/RNAseq/GRCh38_featurecounts/" # path to directory for FeatureCounts gene count files
...
rule all:
	input:
		...
		expand(SAM_AL_DIR + "{sample}_RNA_XY_HISAT2_GRCh38.sam", SAM_AL_DIR=SAM_AL_DIR, sample=SAMPLES),
		expand(BAM_AL_DIR + "{sample}_RNA_XY_HISAT2_GRCh38.bam", BAM_AL_DIR=BAM_AL_DIR, sample=SAMPLES),
		expand(SORTED_BAM_AL_DIR + "{sample}_RNA_XY_HISAT2_GRCh38_sortedbycoord.bam", SORTED_BAM_AL_DIR=SORTED_BAM_AL_DIR, sample=SAMPLES),
		expand(SORTED_BAM_AL_DIR + "{sample}_RNA_XY_HISAT2_GRCh38_sortedbycoord.bam.bai", SORTED_BAM_AL_DIR=SORTED_BAM_AL_DIR, sample=SAMPLES),
		...
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XY_HISAT2_gene_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES),
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XY_HISAT2_gene_autosomal_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES),
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XY_HISAT2_transcript_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES),
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XY_HISAT2_transcript_proteincoding_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES),
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XX_HISAT2_gene_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES),
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XX_HISAT2_gene_autosomal_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES),
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XX_HISAT2_transcript_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES),
		expand(FEATURECOUNTS_DIR + "{sample}_RNA_XX_HISAT2_transcript_proteincoding_featurecounts.tsv", FEATURECOUNTS_DIR=FEATURECOUNTS_DIR, sample=SAMPLES)
