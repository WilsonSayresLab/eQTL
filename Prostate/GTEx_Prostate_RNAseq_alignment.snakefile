...
configfile: "GTEx_Prosstate_v1.5.config.json"
...
XY_HISAT2_INDEX_WITH_VIRAL_REF = config["XY_withoutYpar_HISAT2_index_GRCh38_ref_with_viral_genomes"]
...
# Directories
FQ_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Prostate/RNAseq/trimmed_fastqs/" # path to directory with fastq files
SAM_AL_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Prostate/RNAseq/GRCh38_SAM/" # path to directory for SAM alignment files
BAM_AL_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Prostate/RNAseq/GRCh38_BAM/" # path to directory for BAM alignment files
SORTED_BAM_AL_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Prostate/RNAseq/GRCh38_sorted_BAM/" # path to directory for sorted BAM alignment files
FEATURECOUNTS_DIR = "/mnt/storage/CANCER_DOWNLOADS/PROCESSED/GTEx_Prostate/RNAseq/GRCh38_featurecounts/" # path to directory for FeatureCounts gene count files


# Samples
SAMPLES = config["Prostate_RNA"]
